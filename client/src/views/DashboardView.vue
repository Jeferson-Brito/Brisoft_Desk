...
.executive-eyebrow { color:#059669;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em; }
...
.executive-filters input:focus,.executive-filters select:focus { border-color:#10b981;box-shadow:0 0 0 3px rgba(5,150,105,.1); }
...
.chart-legend { display:flex;align-items:center;gap:10px;color:#64748b;font-size:9px; }.chart-legend span { display:flex;align-items:center;gap:4px; }.chart-legend i { width:7px;height:7px;border-radius:2px; }.received { background:#059669; }.completed { background:#10b981; }
